...
// arc in the x-y, return next index in node array
...
void makeCylinder(float depth, float r, int n, int orientation){
//	int numNodes=2*n;
    int numNodes=2*n+2;
//	int numTriangles=2*n;
    int numTriangles=4*n;
    ...
    draw(1080,1080,lookAt,lookFrom,numNodes,numTriangles,nodes,triangles);

    return;
}

int main(){
    makeCylinder(1.0f, 0.25f, 40, 1);
